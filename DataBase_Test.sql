CREATE DATABASE  IF NOT EXISTS `api_facturacion_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `api_facturacion_test`;
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
-- Host: localhost    Database: api_facturacion_test
-- ------------------------------------------------------
...
INSERT INTO `tb_cargo` VALUES (1,1,'2019-10-31 19:09:17',500,1,4),(2,1,'2019-10-15 00:00:00',1500,5,1),(3,1,'2019-10-16 00:00:00',1200,3,1),(4,2,'2017-12-16 00:00:00',500,4,2),(5,2,'2017-12-16 00:00:00',500,1,2);
...
INSERT INTO `tb_cargo_pago` VALUES (1,500,4,1),(2,500,5,2);
...
INSERT INTO `tb_factura` VALUES (1,'2019-11-01',1),(2,'2017-12-01',1),(3,'2017-12-01',2),(4,'2019-10-31',3);
...
INSERT INTO `tb_pago` VALUES (1,'2017-12-16 00:00:00',500),(2,'2017-12-16 00:00:00',500);
...
INSERT INTO `tb_usuario` VALUES (1,'Smith','msmith@gmail.com','2019-01-01 00:00:00','Mario'),(2,'López','jlopez@gmail.com','2019-01-01 00:00:00','Jorge'),(3,'Test','test@test.com','2019-01-01 00:00:00','Test');
...
-- Dump completed on 2019-10-31 16:42:31
